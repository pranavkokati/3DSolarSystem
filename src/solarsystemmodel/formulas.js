...
export function meanAnomaly(julian_date, planet) {
    const planetaryData = {
...
export function equationOfCenter(M, planet) {
...
export function trueAnomaly(M, C) {
    const v = M + C;
    return v % 360;
}
...
export function distanceToSun(v, planet) {
    const Data = {
...
export function helioCoords(v, planet, r) {
    if (!planetaryData[planet]) {
        throw new Error("Invalid planet name");
    }
